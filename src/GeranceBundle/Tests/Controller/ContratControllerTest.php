...
class ContratControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'contrat[type]' => 'Lorem ipsum dolor sit amet',
            'contrat[dateSignature]' => new \DateTime(),
            'contrat[dateDebut]' => new \DateTime(),
            'contrat[dateFin]' => new \DateTime(),
            'contrat[created]' => new \DateTime(),
            'contrat[modified]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/contrat/new');
