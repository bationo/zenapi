...
class SubCategoryControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'subcategory[name]' => 'Lorem ipsum dolor sit amet',
            'subcategory[slug]' => 'Lorem ipsum dolor sit amet',
            'subcategory[description]' => 'Lorem ipsum dolor sit amet',
            'subcategory[createdAt]' => 'Lorem ipsum dolor sit amet',
            'subcategory[updatedAt]' => 'Lorem ipsum dolor sit amet',
            'subcategory[contentChangedAt]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/sub-categories/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'subcategory[slug]' => 'Changed',
            'subcategory[description]' => 'Changed',
            'subcategory[createdAt]' => 'Changed',
            'subcategory[updatedAt]' => 'Changed',
            'subcategory[contentChangedAt]' => 'Changed',
