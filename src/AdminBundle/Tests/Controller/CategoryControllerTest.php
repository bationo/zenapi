...
class CategoryControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'category[name]' => 'Lorem ipsum dolor sit amet',
            'category[slug]' => 'Lorem ipsum dolor sit amet',
            'category[createdAt]' => 'Lorem ipsum dolor sit amet',
            'category[updatedAt]' => 'Lorem ipsum dolor sit amet',
            'category[contentChangedAt]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'category[createdAt]' => 'Changed',
            'category[updatedAt]' => 'Changed',
            'category[contentChangedAt]' => 'Changed',
