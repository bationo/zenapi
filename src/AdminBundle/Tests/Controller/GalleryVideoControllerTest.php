...
class GalleryVideoControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/gallery_video/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'galleryvideo[link]' => 'Lorem ipsum dolor sit amet',
            'galleryvideo[title]' => 'Lorem ipsum dolor sit amet',
            'galleryvideo[description]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/gallery_video/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'galleryvideo[link]' => 'Changed',
            'galleryvideo[title]' => 'Changed',
            'galleryvideo[description]' => 'Changed',
