...
class MessageControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'message[name]' => 'Lorem ipsum dolor sit amet',
            'message[slug]' => 'Lorem ipsum dolor sit amet',
            'message[subject]' => 'Lorem ipsum dolor sit amet',
            'message[email]' => 'Lorem ipsum dolor sit amet',
            'message[content]' => 'Lorem ipsum dolor sit amet',
            'message[createdAt]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/messages/new');
