...
class TicketControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'ticket[name]' => 'Lorem ipsum dolor sit amet',
            'ticket[phone]' => 'Lorem ipsum dolor sit amet',
            'ticket[address]' => 'Lorem ipsum dolor sit amet',
            'ticket[ticketNumber]' => 42,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/ticket/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'ticket[name]' => 'Changed',
            'ticket[phone]' => 'Changed',
            'ticket[address]' => 'Changed',
            'ticket[ticketNumber]' => 42,
