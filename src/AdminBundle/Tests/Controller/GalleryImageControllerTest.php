...
class GalleryImageControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/gallery_image/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'galleryimage[title]' => 'Lorem ipsum dolor sit amet',
            'galleryimage[description]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/gallery_image/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'galleryimage[title]' => 'Changed',
            'galleryimage[description]' => 'Changed',
