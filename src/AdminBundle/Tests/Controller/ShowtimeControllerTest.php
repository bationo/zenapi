...
class ShowtimeControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/showtimes/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'showtime[place]' => 'Lorem ipsum dolor sit amet',
            'showtime[chronic]' => true,
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/showtimes/new');
