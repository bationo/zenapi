...
class NoticeControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/admin/notices/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'notice[name]' => 'Lorem ipsum dolor sit amet',
            'notice[content]' => 'Lorem ipsum dolor sit amet',
            'notice[rate]' => 42,
            'notice[createdAt]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/notices/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'notice[name]' => 'Changed',
            'notice[content]' => 'Changed',
            'notice[rate]' => 42,
            'notice[createdAt]' => 'Changed',
