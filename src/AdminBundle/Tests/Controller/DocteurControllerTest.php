...
class DocteurControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'docteur[titre]' => 'Lorem ipsum dolor sit amet',
            'docteur[remove]' => 'Lorem ipsum dolor sit amet',
            'docteur[nom]' => 'Lorem ipsum dolor sit amet',
            'docteur[mail]' => 'Lorem ipsum dolor sit amet',
            'docteur[tel]' => 'Lorem ipsum dolor sit amet',
            'docteur[created]' => new \DateTime(),
            'docteur[modified]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/docteur/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'docteur[titre]' => 'Changed',
            'docteur[remove]' => 'Changed',
            'docteur[nom]' => 'Changed',
            'docteur[mail]' => 'Changed',
            'docteur[tel]' => 'Changed',
            'docteur[created]' => new \DateTime(),
            'docteur[modified]' => new \DateTime(),
