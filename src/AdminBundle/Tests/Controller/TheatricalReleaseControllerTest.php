...
class TheatricalReleaseControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/theatrical_release/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'theatricalrelease[dateTime]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/theatrical_release/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'theatricalrelease[dateTime]' => 'Changed',
