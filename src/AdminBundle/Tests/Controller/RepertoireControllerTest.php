...
class RepertoireControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'repertoire[nom]' => 'Lorem ipsum dolor sit amet',
            'repertoire[mail]' => 'Lorem ipsum dolor sit amet',
            'repertoire[tel]' => 'Lorem ipsum dolor sit amet',
            'repertoire[created]' => new \DateTime(),
            'repertoire[modified]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/repertoire/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'repertoire[nom]' => 'Changed',
            'repertoire[mail]' => 'Changed',
            'repertoire[tel]' => 'Changed',
            'repertoire[created]' => new \DateTime(),
            'repertoire[modified]' => new \DateTime(),
