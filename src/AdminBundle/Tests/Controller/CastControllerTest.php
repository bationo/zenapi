...
class CastControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/cast/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'cast[name]' => 'Lorem ipsum dolor sit amet',
            'cast[function]' => 'Lorem ipsum dolor sit amet',
            'cast[presentation]' => 'Lorem ipsum dolor sit amet',
            'cast[publishedAt]' => 'Lorem ipsum dolor sit amet',
            'cast[createdAt]' => 'Lorem ipsum dolor sit amet',
            'cast[updatedAt]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/cast/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'cast[presentation]' => 'Changed',
            'cast[publishedAt]' => 'Changed',
            'cast[createdAt]' => 'Changed',
            'cast[updatedAt]' => 'Changed',
